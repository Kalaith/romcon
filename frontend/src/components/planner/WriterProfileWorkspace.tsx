    ...
    <section className="space-y-6">
      <div className="glass-panel rounded-[2rem] p-6">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-rose-900/75">
          This workspace controls the creative voice sent with AI generation and included in exports. The built-in profile from `writer_profile.md` is the default. You can keep it as-is, or replace it with your own version for this account.
        </p>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        ...
        <section className="space-y-6">
          <div className="glass-panel rounded-[2rem] p-6">
            ...
            <h3 className="font-display text-2xl text-rose-950">Built-in voice from file</h3>
