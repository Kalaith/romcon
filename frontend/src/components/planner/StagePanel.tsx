...
export function StagePanel({ eyebrow, title, description, isLocked = false, lockMessage, children }: StagePanelProps) {
  return (
    <section className={`rounded-[2rem] p-6 ${isLocked ? 'border border-dashed border-rose-200 bg-white/55' : 'glass-panel'}`}>
